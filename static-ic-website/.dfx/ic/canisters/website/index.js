...
import { idlFactory } from './website.did.js';
export { idlFactory } from './website.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WEBSITE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./website.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the website canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./website.did.js")._SERVICE>}
 */
export const website = createActor(canisterId);
